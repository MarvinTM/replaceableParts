...
export const defaultRules = {
  ...
  materials: [
    ...
    { id: 'ladder', name: 'Wooden Ladder', basePrice: 25, category: 'final', weight: 5, age: 1 },
    { id: 'wheelbarrow', name: 'Wheelbarrow', basePrice: 100, category: 'final', weight: 10, age: 1 },
    { id: 'cart', name: 'Hand Cart', basePrice: 200, category: 'final', weight: 20, age: 1 },
    { id: 'barrel', name: 'Wooden Barrel', basePrice: 40, category: 'final', weight: 8, age: 1 },
    { id: 'anvil', name: 'Iron Anvil', basePrice: 80, category: 'final', weight: 30, age: 1 },
    { id: 'bellows', name: 'Forge Bellows', basePrice: 50, category: 'final', weight: 6, age: 1 },
    { id: 'axe', name: 'Iron Axe', basePrice: 15, category: 'final', weight: 4, age: 1 },
    { id: 'saw', name: 'Hand Saw', basePrice: 25, category: 'final', weight: 3, age: 1 },
    { id: 'chisel', name: 'Iron Chisel', basePrice: 10, category: 'final', weight: 2, age: 1 },
    ...
    { id: 'bridge_section', name: 'Wooden Bridge Section', basePrice: 150, category: 'final', weight: 20, age: 1 },
    { id: 'plow', name: 'Iron Plow', basePrice: 45, category: 'final', weight: 12, age: 1 },
    { id: 'stone_pillar', name: 'Stone Pillar', basePrice: 30, category: 'final', weight: 15, age: 1 },
    { id: 'tool_rack', name: 'Tool Rack', basePrice: 20, category: 'final', weight: 5, age: 1 },
    { id: 'shield_rack', name: 'Weapon Rack', basePrice: 25, category: 'final', weight: 6, age: 1 },
    { id: 'iron_grate', name: 'Iron Grate', basePrice: 40, category: 'final', weight: 8, age: 1 },
    ...
    { id: 'vase', name: 'Ceramic Vase', basePrice: 35, category: 'final', weight: 5, age: 2 },
    { id: 'pot', name: 'Cooking Pot', basePrice: 90, category: 'final', weight: 4, age: 2 },
    { id: 'mirror', name: 'Wall Mirror', basePrice: 70, category: 'final', weight: 6, age: 2 },
    { id: 'window', name: 'Glass Window', basePrice: 45, category: 'final', weight: 8, age: 2 },
    { id: 'lantern', name: 'Oil Lantern', basePrice: 85, category: 'final', weight: 5, age: 2 },
    { id: 'kettle', name: 'Copper Kettle', basePrice: 125, category: 'final', weight: 3, age: 2 },
    { id: 'fountain', name: 'Ceramic Fountain', basePrice: 100, category: 'final', weight: 20, age: 2 },
    { id: 'aqueduct_section', name: 'Aqueduct Section', basePrice: 240, category: 'final', weight: 50, age: 2 },
    { id: 'spyglass', name: 'Spyglass', basePrice: 160, category: 'final', weight: 2, age: 2 },
    { id: 'chandelier', name: 'Glass Chandelier', basePrice: 190, category: 'final', weight: 8, age: 2 },
    { id: 'stained_glass', name: 'Stained Glass Panel', basePrice: 200, category: 'final', weight: 6, age: 2 },
    { id: 'telescope', name: 'Telescope', basePrice: 50, category: 'final', weight: 5, age: 2 },
    { id: 'compass', name: 'Brass Compass', basePrice: 130, category: 'final', weight: 1, age: 2 },
    { id: 'plate_set', name: 'Porcelain Plate Set', basePrice: 125, category: 'final', weight: 4, age: 2 },
    { id: 'tile_floor', name: 'Tile Floor Section', basePrice: 45, category: 'final', weight: 10, age: 2 },
    { id: 'bathtub', name: 'Copper Bathtub', basePrice: 380, category: 'final', weight: 25, age: 2 },
    { id: 'sink', name: 'Copper Sink', basePrice: 160, category: 'final', weight: 8, age: 2 },
    { id: 'decorative_urn', name: 'Decorative Urn', basePrice: 40, category: 'final', weight: 6, age: 2 },
    { id: 'chimney', name: 'Brick Chimney', basePrice: 85, category: 'final', weight: 15, age: 2 },
    { id: 'greenhouse_panel', name: 'Greenhouse Panel', basePrice: 38, category: 'final', weight: 5, age: 2 },
    { id: 'church_bell', name: 'Church Bell', basePrice: 240, category: 'final', weight: 20, age: 2 },
    { id: 'candelabra', name: 'Brass Candelabra', basePrice: 320, category: 'final', weight: 3, age: 2 },
    { id: 'pottery_wheel', name: 'Pottery Wheel', basePrice: 130, category: 'final', weight: 12, age: 2 },
    { id: 'barometer', name: 'Barometer', basePrice: 45, category: 'final', weight: 3, age: 2 },
    { id: 'hourglass', name: 'Hourglass', basePrice: 35, category: 'final', weight: 2, age: 2 },
    { id: 'ceramic_bowl', name: 'Ceramic Bowl', basePrice: 28, category: 'final', weight: 2, age: 2 },
    { id: 'copper_statue', name: 'Copper Statue', basePrice: 240, category: 'final', weight: 15, age: 2 },
    { id: 'magnifying_glass', name: 'Magnifying Glass', basePrice: 120, category: 'final', weight: 1, age: 2 },
    { id: 'sundial', name: 'Stone Sundial', basePrice: 160, category: 'final', weight: 8, age: 2 },
    { id: 'bronze_armor', name: 'Bronze Armor', basePrice: 380, category: 'final', weight: 20, age: 2 },
    ...
    { id: 'vault_door', name: 'Vault Door', basePrice: 3000, category: 'final', weight: 50, age: 3 },
    { id: 'stove', name: 'Wood Stove', basePrice: 600, category: 'final', weight: 40, age: 3 },
    { id: 'bicycle', name: 'Bicycle', basePrice: 850, category: 'final', weight: 15, age: 3 },
    { id: 'clock', name: 'Grandfather Clock', basePrice: 800, category: 'final', weight: 25, age: 3 },
    { id: 'printing_press', name: 'Printing Press', basePrice: 3600, category: 'final', weight: 60, age: 3 },
    { id: 'sewing_machine', name: 'Sewing Machine', basePrice: 750, category: 'final', weight: 15, age: 3 },
    { id: 'tool_box', name: 'Mechanic\'s Toolbox', basePrice: 1155, category: 'final', weight: 10, age: 3 },
    { id: 'radiator', name: 'Steam Radiator', basePrice: 1800, category: 'final', weight: 20, age: 3 },
    { id: 'locomotive', name: 'Steam Locomotive', basePrice: 6500, category: 'final', weight: 200, age: 3 },
    { id: 'industrial_furnace', name: 'Industrial Furnace', basePrice: 2500, category: 'final', weight: 80, age: 3 },
    { id: 'lathe', name: 'Metal Lathe', basePrice: 3700, category: 'final', weight: 50, age: 3 },
    { id: 'milling_machine', name: 'Milling Machine', basePrice: 2500, category: 'final', weight: 55, age: 3 },
    { id: 'safe', name: 'Steel Safe', basePrice: 5750, category: 'final', weight: 45, age: 3 },
    { id: 'crane', name: 'Industrial Crane', basePrice: 4600, category: 'final', weight: 100, age: 3 },
    { id: 'elevator', name: 'Elevator System', basePrice: 3300, category: 'final', weight: 90, age: 3 },
    { id: 'mechanical_loom', name: 'Mechanical Loom', basePrice: 2300, category: 'final', weight: 40, age: 3 },
    { id: 'pocket_watch', name: 'Pocket Watch', basePrice: 1800, category: 'final', weight: 1, age: 3 },
    { id: 'manhole_cover', name: 'Manhole Cover', basePrice: 850, category: 'final', weight: 20, age: 3 },
    { id: 'steel_bridge', name: 'Steel Bridge Section', basePrice: 3800, category: 'final', weight: 120, age: 3 },
    { id: 'water_tower', name: 'Water Tower', basePrice: 7250, category: 'final', weight: 100, age: 3 },
    { id: 'industrial_press', name: 'Hydraulic Press', basePrice: 2300, category: 'final', weight: 70, age: 3 },
    { id: 'steam_hammer', name: 'Steam Hammer', basePrice: 4300, category: 'final', weight: 85, age: 3 },
    { id: 'rail_track', name: 'Rail Track Section', basePrice: 80, category: 'final', weight: 40, age: 3 },
    { id: 'padlock', name: 'Steel Padlock', basePrice: 200, category: 'final', weight: 2, age: 3 },
    { id: 'wrench', name: 'Steel Wrench', basePrice: 175, category: 'final', weight: 2, age: 3 },
    { id: 'pipe_organ', name: 'Pipe Organ', basePrice: 2300, category: 'final', weight: 150, age: 3 },
    { id: 'industrial_boiler', name: 'Industrial Boiler', basePrice: 7250, category: 'final', weight: 95, age: 3 },
    { id: 'conveyor_belt', name: 'Conveyor Belt', basePrice: 3200, category: 'final', weight: 50, age: 3 },
    { id: 'pressure_cooker', name: 'Pressure Cooker', basePrice: 1500, category: 'final', weight: 15, age: 3 },
    { id: 'plumbing_system', name: 'Plumbing System', basePrice: 2400, category: 'final', weight: 35, age: 3 },
    { id: 'rotary_engine', name: 'Rotary Engine', basePrice: 3000, category: 'final', weight: 110, age: 3 },
    ...
    { id: 'car_tire', name: 'Car Wheel', basePrice: 1800, category: 'final', weight: 10, age: 4 },
    { id: 'lawn_mower', name: 'Lawn Mower', basePrice: 10000, category: 'final', weight: 25, age: 4 },
    { id: 'chainsaw', name: 'Chainsaw', basePrice: 5000, category: 'final', weight: 10, age: 4 },
    { id: 'generator', name: 'Portable Generator', basePrice: 6250, category: 'final', weight: 40, age: 4 },
    { id: 'scooter', name: 'Motor Scooter', basePrice: 9000, category: 'final', weight: 50, age: 4 },
    { id: 'radio_transmitter', name: 'Radio Transmitter', basePrice: 100, category: 'final', weight: 2, age: 4 },
    { id: 'typewriter', name: 'Typewriter', basePrice: 3400, category: 'final', weight: 8, age: 4 },
    { id: 'camera', name: 'Film Camera', basePrice: 325, category: 'final', weight: 2, age: 4 },
    { id: 'motorcycle', name: 'Motorcycle', basePrice: 10500, category: 'final', weight: 80, age: 4 },
    { id: 'car_engine', name: 'Automobile Engine', basePrice: 5500, category: 'final', weight: 120, age: 4 },
    { id: 'industrial_pump', name: 'Industrial Pump', basePrice: 6250, category: 'final', weight: 45, age: 4 },
    { id: 'power_saw', name: 'Power Saw', basePrice: 4600, category: 'final', weight: 12, age: 4 },
    { id: 'jackhammer', name: 'Pneumatic Jackhammer', basePrice: 4700, category: 'final', weight: 28, age: 4 },
    { id: 'concrete_mixer', name: 'Concrete Mixer', basePrice: 13500, category: 'final', weight: 75, age: 4 },
    { id: 'traffic_light', name: 'Traffic Signal', basePrice: 475, category: 'final', weight: 15, age: 4 },
    { id: 'street_lamp', name: 'Street Lamp', basePrice: 850, category: 'final', weight: 12, age: 4 },
    { id: 'telephone', name: 'Telephone', basePrice: 175, category: 'final', weight: 3, age: 4 },
    { id: 'vinyl_record', name: 'Vinyl Record', basePrice: 10, category: 'final', weight: 1, age: 4 },
    { id: 'plastic_container', name: 'Plastic Container', basePrice: 10, category: 'final', weight: 1, age: 4 },
    { id: 'garden_hose', name: 'Garden Hose', basePrice: 225, category: 'final', weight: 3, age: 4 },
    { id: 'fuel_tank', name: 'Fuel Storage Tank', basePrice: 4100, category: 'final', weight: 30, age: 4 },
    { id: 'oil_drum', name: 'Oil Drum', basePrice: 1700, category: 'final', weight: 15, age: 4 },
    { id: 'flashlight', name: 'Flashlight', basePrice: 1000, category: 'final', weight: 1, age: 4 },
    { id: 'automobile', name: 'Automobile', basePrice: 19000, category: 'final', weight: 250, age: 4 },
    { id: 'road_segment', name: 'Paved Road Section', basePrice: 325, category: 'final', weight: 100, age: 4 },
    { id: 'leather_jacket', name: 'Leather Jacket', basePrice: 125, category: 'final', weight: 3, age: 4 },
    { id: 'amplifier', name: 'Tube Amplifier', basePrice: 1200, category: 'final', weight: 8, age: 4 },
    { id: 'diesel_truck', name: 'Diesel Truck', basePrice: 24500, category: 'final', weight: 350, age: 4 },
    { id: 'chemistry_set', name: 'Chemistry Set', basePrice: 100, category: 'final', weight: 4, age: 4 },
    { id: 'raincoat', name: 'Raincoat', basePrice: 150, category: 'final', weight: 2, age: 4 },
    { id: 'kayak', name: 'Fiberglass Kayak', basePrice: 200, category: 'final', weight: 15, age: 4 },
    ...
    { id: 'fan', name: 'Electric Fan', basePrice: 1900, category: 'final', weight: 5, age: 5 },
    { id: 'toaster', name: 'Toaster', basePrice: 1400, category: 'final', weight: 3, age: 5 },
    { id: 'vacuum', name: 'Vacuum Cleaner', basePrice: 1700, category: 'final', weight: 10, age: 5 },
    { id: 'fridge', name: 'Refrigerator', basePrice: 6500, category: 'final', weight: 80, age: 5 },
    { id: 'washer', name: 'Washing Machine', basePrice: 7250, category: 'final', weight: 70, age: 5 },
    { id: 'radio', name: 'AM/FM Radio', basePrice: 550, category: 'final', weight: 4, age: 5 },
    { id: 'drill', name: 'Power Drill', basePrice: 1700, category: 'final', weight: 4, age: 5 },
    { id: 'mixer', name: 'Industrial Mixer', basePrice: 1500, category: 'final', weight: 3, age: 5 },
    { id: 'dishwasher', name: 'Dishwasher', basePrice: 7500, category: 'final', weight: 65, age: 5 },
    { id: 'air_conditioner', name: 'Air Conditioner', basePrice: 5500, category: 'final', weight: 75, age: 5 },
    { id: 'electric_oven', name: 'Electric Oven', basePrice: 10000, category: 'final', weight: 50, age: 5 },
    { id: 'hair_dryer', name: 'Hair Dryer', basePrice: 2200, category: 'final', weight: 1, age: 5 },
    { id: 'electric_heater', name: 'Electric Heater', basePrice: 4300, category: 'final', weight: 8, age: 5 },
    { id: 'electric_kettle', name: 'Electric Kettle', basePrice: 750, category: 'final', weight: 2, age: 5 },
    { id: 'blender', name: 'Blender', basePrice: 1400, category: 'final', weight: 2, age: 5 },
    { id: 'food_processor', name: 'Food Processor', basePrice: 3200, category: 'final', weight: 4, age: 5 },
    { id: 'electric_saw', name: 'Electric Saw', basePrice: 2400, category: 'final', weight: 6, age: 5 },
    { id: 'arc_welder', name: 'Arc Welder', basePrice: 4100, category: 'final', weight: 25, age: 5 },
    { id: 'electric_guitar', name: 'Electric Guitar', basePrice: 650, category: 'final', weight: 4, age: 5 },
    { id: 'jukebox', name: 'Jukebox', basePrice: 1400, category: 'final', weight: 50, age: 5 },
    { id: 'ceiling_fan', name: 'Ceiling Fan', basePrice: 2000, category: 'final', weight: 6, age: 5 },
    { id: 'water_heater', name: 'Water Heater', basePrice: 6000, category: 'final', weight: 40, age: 5 },
    { id: 'sander', name: 'Electric Sander', basePrice: 1300, category: 'final', weight: 3, age: 5 },
    { id: 'elevator_motor', name: 'Elevator Motor', basePrice: 12000, category: 'final', weight: 45, age: 5 },
    { id: 'motor_housing_unit', name: 'Motor Housing Unit', basePrice: 4200, category: 'final', weight: 12, age: 5 },
    { id: 'insulated_pipe', name: 'Insulated Pipe', basePrice: 1600, category: 'final', weight: 8, age: 5 },
    { id: 'relay_panel', name: 'Relay Control Panel', basePrice: 5500, category: 'final', weight: 15, age: 5 },
    { id: 'wire_spool', name: 'Steel Wire Spool', basePrice: 2000, category: 'final', weight: 6, age: 5 },
    { id: 'lamp_fixture', name: 'Lamp Fixture', basePrice: 3200, category: 'final', weight: 3, age: 5 },
    ...
    // Final Goods (Tech)
    { id: 'computer', name: 'Desktop Computer', basePrice: 27500, category: 'final', weight: 15, age: 6 },
    { id: 'tv', name: 'Flat Screen TV', basePrice: 3100, category: 'final', weight: 20, age: 6 },
    { id: 'microwave', name: 'Microwave Oven', basePrice: 7750, category: 'final', weight: 15, age: 6 },
    { id: 'calculator', name: 'Calculator', basePrice: 1900, category: 'final', weight: 1, age: 6 },
    { id: 'console', name: 'Game Console', basePrice: 11000, category: 'final', weight: 5, age: 6 },
    { id: 'printer', name: 'Laser Printer', basePrice: 6250, category: 'final', weight: 12, age: 6 },
    { id: 'watch_digital', name: 'Digital Watch', basePrice: 4100, category: 'final', weight: 0.5, age: 6 },
    { id: 'laptop', name: 'Laptop Computer', basePrice: 10500, category: 'final', weight: 3, age: 6 },
    { id: 'server', name: 'Server Rack', basePrice: 68000, category: 'final', weight: 40, age: 6 },
    { id: 'monitor', name: 'Computer Monitor', basePrice: 2000, category: 'final', weight: 5, age: 6 },
    { id: 'scanner', name: 'Document Scanner', basePrice: 4300, category: 'final', weight: 6, age: 6 },
    { id: 'modem', name: 'Cable Modem', basePrice: 450, category: 'final', weight: 1, age: 6 },
    { id: 'router', name: 'Network Router', basePrice: 1100, category: 'final', weight: 2, age: 6 },
    { id: 'digital_camera', name: 'Digital Camera', basePrice: 7500, category: 'final', weight: 1, age: 6 },
    { id: 'mp3_player', name: 'MP3 Player', basePrice: 6500, category: 'final', weight: 0.5, age: 6 },
    { id: 'electronic_lock', name: 'Electronic Door Lock', basePrice: 6500, category: 'final', weight: 2, age: 6 },
    { id: 'gps_device', name: 'GPS Navigator', basePrice: 7000, category: 'final', weight: 1, age: 6 },
    { id: 'barcode_scanner', name: 'Barcode Scanner', basePrice: 1500, category: 'final', weight: 1, age: 6 },
    { id: 'atm_machine', name: 'ATM Machine', basePrice: 90000, category: 'final', weight: 80, age: 6 },
    { id: 'pos_terminal', name: 'POS Terminal', basePrice: 2600, category: 'final', weight: 3, age: 6 },
    { id: 'led_display', name: 'LED Display Panel', basePrice: 4900, category: 'final', weight: 15, age: 6 },
    { id: 'surveillance_camera', name: 'Security Camera', basePrice: 10500, category: 'final', weight: 2, age: 6 },
    { id: 'tablet', name: 'Tablet Computer', basePrice: 11000, category: 'final', weight: 1, age: 6 },
    { id: 'bracket_assembly', name: 'Bracket Assembly', basePrice: 8500, category: 'final', weight: 5, age: 6 },
    { id: 'computer_station', name: 'Computer Workstation', basePrice: 34500, category: 'final', weight: 35, age: 6 },
    { id: 'cable_organizer', name: 'Cable Management System', basePrice: 600, category: 'final', weight: 3, age: 6 },
    ...
    // Final Goods
    { id: 'smartphone', name: 'Smartphone', basePrice: 13500, category: 'final', weight: 1, age: 7 },
    { id: 'drone', name: 'Quad-Drone', basePrice: 28500, category: 'final', weight: 4, age: 7 },
    { id: 'robot', name: 'Service Robot', basePrice: 110000, category: 'final', weight: 50, age: 7 },
    { id: 'vr_headset', name: 'VR Headset', basePrice: 19000, category: 'final', weight: 2, age: 7 },
    { id: 'electric_car', name: 'Electric Car', basePrice: 33500, category: 'final', weight: 200, age: 7 },
    { id: 'laser', name: 'Lab Laser', basePrice: 36000, category: 'final', weight: 10, age: 7 },
    { id: 'solar_panel_item', name: 'Solar Panel', basePrice: 12500, category: 'final', weight: 10, age: 7 },
    { id: 'flying_car', name: 'Flying Car', basePrice: 81000, category: 'final', weight: 180, age: 7 },
    { id: 'hoverboard', name: 'Hoverboard', basePrice: 30500, category: 'final', weight: 8, age: 7 },
    { id: 'printer_3d', name: '3D Printer', basePrice: 76000, category: 'final', weight: 35, age: 7 },
    { id: 'holographic_display', name: 'Holographic Display', basePrice: 305000, category: 'final', weight: 12, age: 7 },
    { id: 'ar_glasses', name: 'AR Glasses', basePrice: 80000, category: 'final', weight: 0.5, age: 7 },
    { id: 'exoskeleton', name: 'Powered Exoskeleton', basePrice: 120000, category: 'final', weight: 40, age: 7 },
    { id: 'personal_assistant_robot', name: 'Personal Assistant Robot', basePrice: 185000, category: 'final', weight: 25, age: 7 },
    { id: 'smart_home_hub', name: 'Smart Home Hub', basePrice: 69000, category: 'final', weight: 2, age: 7 },
    { id: 'autonomous_vehicle', name: 'Autonomous Vehicle', basePrice: 180000, category: 'final', weight: 220, age: 7 },
    { id: 'space_suit', name: 'Space Suit', basePrice: 34500, category: 'final', weight: 15, age: 7 },
    { id: 'medical_scanner', name: 'Medical Scanner', basePrice: 140000, category: 'final', weight: 50, age: 7 },
    { id: 'quantum_computer', name: 'Quantum Computer', basePrice: 335000, category: 'final', weight: 60, age: 7 },
    { id: 'teleporter_pad', name: 'Teleportation Pad', basePrice: 410000, category: 'final', weight: 500, age: 7 },
    { id: 'energy_shield', name: 'Energy Shield Generator', basePrice: 46000, category: 'final', weight: 30, age: 7 },
    { id: 'weather_control', name: 'Weather Control Device', basePrice: 500000, category: 'final', weight: 150, age: 7 },
    { id: 'replicator', name: 'Matter Replicator', basePrice: 830000, category: 'final', weight: 100, age: 7 },
    { id: 'cryogenic_chamber', name: 'Cryogenic Chamber', basePrice: 17500, category: 'final', weight: 180, age: 7 },
    { id: 'space_helmet', name: 'Space Helmet', basePrice: 7500, category: 'final', weight: 5, age: 7 },
    { id: 'graphene_armor', name: 'Graphene Armor', basePrice: 55000, category: 'final', weight: 8, age: 7 },
    { id: 'neural_implant', name: 'Neural Implant', basePrice: 140000, category: 'final', weight: 0.5, age: 7 },
