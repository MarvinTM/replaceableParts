...
export const defaultRules = {
  ...
  recipes: [
    ...
    { id: 'shield', inputs: { wooden_beam: 2, iron_plate: 2 }, outputs: { shield: 1 }, ticksToComplete: 4, tier: 1, age: 1 },
    ...
    { id: 'plow', inputs: { iron_plate: 2, wooden_beam: 1, wooden_handle: 1 }, outputs: { plow: 1 }, ticksToComplete: 4, tier: 1, age: 1 },
    ...
    { id: 'plastic_container', inputs: { plastic: 1 }, outputs: { plastic_container: 4 }, ticksToComplete: 1, tier: 4, age: 4 },
    ...
    { id: 'laser', inputs: { rare_earth_ore: 1, glass: 2, circuit_board: 2 }, outputs: { laser: 1 }, ticksToComplete: 15, tier: 7, age: 7 },
