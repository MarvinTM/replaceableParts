...
export const defaultRules = {
  ...
  materials: [
    ...
    { id: 'bed', name: 'Wooden Bed', basePrice: 28, category: 'final', weight: 12, age: 1 },
    ...
    { id: 'wheelbarrow', name: 'Wheelbarrow', basePrice: 35, category: 'final', weight: 10, age: 1 },
    { id: 'cart', name: 'Hand Cart', basePrice: 45, category: 'final', weight: 20, age: 1 },
    ...
    { id: 'axe', name: 'Iron Axe', basePrice: 24, category: 'final', weight: 4, age: 1 },
    { id: 'saw', name: 'Hand Saw', basePrice: 20, category: 'final', weight: 3, age: 1 },
    { id: 'chisel', name: 'Iron Chisel', basePrice: 15, category: 'final', weight: 2, age: 1 },
    ...
    { id: 'spear', name: 'Iron Spear', basePrice: 22, category: 'final', weight: 4, age: 1 },
    { id: 'gate', name: 'Wooden Gate', basePrice: 38, category: 'final', weight: 15, age: 1 },
    { id: 'staircase', name: 'Wooden Staircase', basePrice: 32, category: 'final', weight: 12, age: 1 },
    { id: 'roof_tile_section', name: 'Roof Tile Section', basePrice: 16, category: 'final', weight: 8, age: 1 },
    { id: 'well', name: 'Stone Well', basePrice: 55, category: 'final', weight: 25, age: 1 },
    ...
    { id: 'bridge_section', name: 'Wooden Bridge Section', basePrice: 42, category: 'final', weight: 20, age: 1 },
    ...
    { id: 'tool_rack', name: 'Tool Rack', basePrice: 18, category: 'final', weight: 5, age: 1 },
    ...
    { id: 'coat_hanger', name: 'Coat Hanger', basePrice: 8, category: 'final', weight: 2, age: 1 },
    ...
    { id: 'flying_car', name: 'Flying Car', basePrice: 8000, category: 'final', weight: 180, age: 7 },
    ...
    { id: 'autonomous_vehicle', name: 'Autonomous Vehicle', basePrice: 6500, category: 'final', weight: 220, age: 7 },
    ...
    { id: 'teleporter_pad', name: 'Teleportation Pad', basePrice: 25000, category: 'final', weight: 500, age: 7 },
    ...
    { id: 'cryogenic_chamber', name: 'Cryogenic Chamber', basePrice: 3200, category: 'final', weight: 180, age: 7 },
  ...
  recipes: [
    ...
    { id: 'rope', inputs: { wood: 1 }, outputs: { rope: 3 }, energyRequired: 1, ticksToComplete: 1, tier: 1, age: 1 },
    { id: 'wooden_dowel', inputs: { planks: 1 }, outputs: { wooden_dowel: 4 }, energyRequired: 1, ticksToComplete: 1, tier: 1, age: 1 },
    { id: 'stone_slab', inputs: { stone: 2 }, outputs: { stone_slab: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'iron_wire', inputs: { iron_rod: 1 }, outputs: { iron_wire: 4 }, energyRequired: 1, ticksToComplete: 1, tier: 1, age: 1 },
    { id: 'iron_bracket', inputs: { iron_plate: 1 }, outputs: { iron_bracket: 2 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'hinges', inputs: { iron_plate: 1, iron_rod: 1 }, outputs: { hinges: 2 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'mortar', inputs: { stone: 1, sand: 1 }, outputs: { mortar: 3 }, energyRequired: 1, ticksToComplete: 1, tier: 1, age: 1 },
    { id: 'iron_chain', inputs: { iron_wire: 2 }, outputs: { iron_chain: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'stone_tile', inputs: { stone_bricks: 1 }, outputs: { stone_tile: 4 }, energyRequired: 1, ticksToComplete: 1, tier: 1, age: 1 },
    { id: 'wooden_shingle', inputs: { planks: 1 }, outputs: { wooden_shingle: 6 }, energyRequired: 1, ticksToComplete: 1, tier: 1, age: 1 },
    { id: 'iron_axle', inputs: { iron_rod: 2, iron_ingot: 1 }, outputs: { iron_axle: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 1, age: 1 },
    { id: 'wheel', inputs: { planks: 4, iron_rod: 2 }, outputs: { wheel: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 1, age: 1 },
    { id: 'wooden_handle', inputs: { planks: 1 }, outputs: { wooden_handle: 2 }, energyRequired: 1, ticksToComplete: 1, tier: 1, age: 1 },
    ...
    { id: 'bed', inputs: { planks: 6, wooden_beam: 2, rope: 2 }, outputs: { bed: 1 }, energyRequired: 3, ticksToComplete: 5, tier: 1, age: 1 },
    { id: 'bench', inputs: { planks: 3, nails: 2 }, outputs: { bench: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'ladder', inputs: { wooden_beam: 2, nails: 4 }, outputs: { ladder: 1 }, energyRequired: 2, ticksToComplete: 3, tier: 1, age: 1 },
    { id: 'wheelbarrow', inputs: { planks: 4, iron_plate: 1, wheel: 1 }, outputs: { wheelbarrow: 1 }, energyRequired: 3, ticksToComplete: 4, tier: 1, age: 1 },
    { id: 'cart', inputs: { wooden_beam: 3, wheel: 2, iron_bracket: 2 }, outputs: { cart: 1 }, energyRequired: 4, ticksToComplete: 5, tier: 1, age: 1 },
    { id: 'barrel', inputs: { planks: 4, iron_rod: 2 }, outputs: { barrel: 1 }, energyRequired: 2, ticksToComplete: 3, tier: 1, age: 1 },
    { id: 'anvil', inputs: { iron_ingot: 5 }, outputs: { anvil: 1 }, energyRequired: 5, ticksToComplete: 4, tier: 1, age: 1 },
    { id: 'bellows', inputs: { planks: 3, iron_plate: 1, rope: 1 }, outputs: { bellows: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 1, age: 1 },
    { id: 'axe', inputs: { iron_ingot: 1, wooden_handle: 1 }, outputs: { axe: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'saw', inputs: { iron_plate: 1, wooden_handle: 1 }, outputs: { saw: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'chisel', inputs: { iron_rod: 1, wooden_handle: 1 }, outputs: { chisel: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'mallet', inputs: { planks: 2, wooden_handle: 1 }, outputs: { mallet: 1 }, energyRequired: 1, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'shield', inputs: { wooden_beam: 2, iron_plate: 2 }, outputs: { shield: 1 }, energyRequired: 3, ticksToComplete: 4, tier: 1, age: 1 },
    { id: 'spear', inputs: { iron_rod: 2, wooden_handle: 1 }, outputs: { spear: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'gate', inputs: { wooden_beam: 3, hinges: 2, iron_plate: 1 }, outputs: { gate: 1 }, energyRequired: 4, ticksToComplete: 5, tier: 1, age: 1 },
    { id: 'staircase', inputs: { wooden_beam: 3, planks: 4, nails: 6 }, outputs: { staircase: 1 }, energyRequired: 3, ticksToComplete: 4, tier: 1, age: 1 },
    { id: 'roof_tile_section', inputs: { stone_tile: 6 }, outputs: { roof_tile_section: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'well', inputs: { stone_bricks: 8, rope: 2, bucket: 1 }, outputs: { well: 1 }, energyRequired: 5, ticksToComplete: 6, tier: 1, age: 1 },
    { id: 'workbench', inputs: { planks: 6, wooden_beam: 1 }, outputs: { workbench: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 1, age: 1 },
    { id: 'forge', inputs: { stone_bricks: 6, iron_plate: 2 }, outputs: { forge: 1 }, energyRequired: 4, ticksToComplete: 5, tier: 1, age: 1 },
    { id: 'crate', inputs: { planks: 4, nails: 4 }, outputs: { crate: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'bridge_section', inputs: { wooden_beam: 4, planks: 6, iron_bracket: 2 }, outputs: { bridge_section: 1 }, energyRequired: 4, ticksToComplete: 5, tier: 1, age: 1 },
    { id: 'plow', inputs: { iron_plate: 2, wooden_beam: 1, wooden_handle: 1 }, outputs: { plow: 1 }, energyRequired: 3, ticksToComplete: 4, tier: 1, age: 1 },
    { id: 'stone_pillar', inputs: { stone_slab: 2, mortar: 1 }, outputs: { stone_pillar: 1 }, energyRequired: 3, ticksToComplete: 4, tier: 1, age: 1 },
    { id: 'tool_rack', inputs: { planks: 3, nails: 3 }, outputs: { tool_rack: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'shield_rack', inputs: { planks: 4, nails: 4 }, outputs: { shield_rack: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
    { id: 'iron_grate', inputs: { iron_rod: 6 }, outputs: { iron_grate: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 1, age: 1 },
    { id: 'coat_hanger', inputs: { wooden_dowel: 4, iron_wire: 2 }, outputs: { coat_hanger: 1 }, energyRequired: 1, ticksToComplete: 1, tier: 1, age: 1 },
    ...
    { id: 'ceramic_tile', inputs: { clay: 2 }, outputs: { ceramic_tile: 4 }, energyRequired: 2, ticksToComplete: 2, tier: 2, age: 2 },
    { id: 'glass_pane', inputs: { glass: 1 }, outputs: { glass_pane: 4 }, energyRequired: 2, ticksToComplete: 1, tier: 2, age: 2 },
    { id: 'copper_tubing', inputs: { copper_sheet: 1 }, outputs: { copper_tubing: 3 }, energyRequired: 2, ticksToComplete: 2, tier: 2, age: 2 },
    { id: 'brass_ingot', inputs: { copper_ingot: 1, iron_ingot: 1 }, outputs: { brass_ingot: 1 }, energyRequired: 4, ticksToComplete: 3, tier: 2, age: 2 },
    { id: 'brass_sheet', inputs: { brass_ingot: 2 }, outputs: { brass_sheet: 1 }, energyRequired: 3, ticksToComplete: 2, tier: 2, age: 2 },
    { id: 'decorative_glass', inputs: { glass: 1, copper_sheet: 1 }, outputs: { decorative_glass: 1 }, energyRequired: 4, ticksToComplete: 3, tier: 2, age: 2 },
    { id: 'terracotta', inputs: { clay: 2 }, outputs: { terracotta: 2 }, energyRequired: 3, ticksToComplete: 2, tier: 2, age: 2 },
    { id: 'porcelain', inputs: { clay: 2, sand: 1 }, outputs: { porcelain: 1 }, energyRequired: 4, ticksToComplete: 3, tier: 2, age: 2 },
    { id: 'glass_lens', inputs: { glass: 1 }, outputs: { glass_lens: 2 }, energyRequired: 3, ticksToComplete: 2, tier: 2, age: 2 },
    { id: 'copper_rod', inputs: { copper_ingot: 1 }, outputs: { copper_rod: 2 }, energyRequired: 2, ticksToComplete: 1, tier: 2, age: 2 },
    { id: 'bronze_ingot', inputs: { copper_ingot: 2, iron_ingot: 1 }, outputs: { bronze_ingot: 2 }, energyRequired: 4, ticksToComplete: 3, tier: 2, age: 2 },
    ...
    { id: 'chandelier', inputs: { glass: 3, copper_sheet: 2, iron_chain: 1 }, outputs: { chandelier: 1 }, energyRequired: 6, ticksToComplete: 6, tier: 2, age: 2 },
    { id: 'stained_glass', inputs: { decorative_glass: 2, iron_rod: 2 }, outputs: { stained_glass: 1 }, energyRequired: 5, ticksToComplete: 5, tier: 2, age: 2 },
    { id: 'telescope', inputs: { glass_lens: 3, copper_tubing: 2 }, outputs: { telescope: 1 }, energyRequired: 7, ticksToComplete: 6, tier: 2, age: 2 },
    { id: 'compass', inputs: { brass_sheet: 1, glass_pane: 1, copper_rod: 1 }, outputs: { compass: 1 }, energyRequired: 4, ticksToComplete: 4, tier: 2, age: 2 },
    { id: 'plate_set', inputs: { porcelain: 3 }, outputs: { plate_set: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 2, age: 2 },
    { id: 'tile_floor', inputs: { ceramic_tile: 8 }, outputs: { tile_floor: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 2, age: 2 },
    { id: 'bathtub', inputs: { copper_sheet: 4, pipe: 2 }, outputs: { bathtub: 1 }, energyRequired: 7, ticksToComplete: 7, tier: 2, age: 2 },
    { id: 'sink', inputs: { copper_sheet: 2, pipe: 1 }, outputs: { sink: 1 }, energyRequired: 4, ticksToComplete: 4, tier: 2, age: 2 },
    { id: 'decorative_urn', inputs: { terracotta: 2 }, outputs: { decorative_urn: 1 }, energyRequired: 4, ticksToComplete: 4, tier: 2, age: 2 },
    { id: 'chimney', inputs: { bricks: 6, pipe: 1 }, outputs: { chimney: 1 }, energyRequired: 5, ticksToComplete: 5, tier: 2, age: 2 },
    { id: 'greenhouse_panel', inputs: { glass_pane: 4, iron_rod: 2 }, outputs: { greenhouse_panel: 1 }, energyRequired: 4, ticksToComplete: 4, tier: 2, age: 2 },
    { id: 'church_bell', inputs: { brass_ingot: 3, iron_bracket: 1 }, outputs: { church_bell: 1 }, energyRequired: 8, ticksToComplete: 7, tier: 2, age: 2 },
    { id: 'candelabra', inputs: { brass_sheet: 2, copper_rod: 1 }, outputs: { candelabra: 1 }, energyRequired: 4, ticksToComplete: 4, tier: 2, age: 2 },
    { id: 'pottery_wheel', inputs: { wooden_beam: 2, stone: 1, copper_sheet: 1 }, outputs: { pottery_wheel: 1 }, energyRequired: 5, ticksToComplete: 5, tier: 2, age: 2 },
    { id: 'barometer', inputs: { glass: 1, copper_tubing: 2 }, outputs: { barometer: 1 }, energyRequired: 5, ticksToComplete: 5, tier: 2, age: 2 },
    { id: 'hourglass', inputs: { glass: 2, sand: 1 }, outputs: { hourglass: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 2, age: 2 },
    { id: 'ceramic_bowl', inputs: { clay: 2 }, outputs: { ceramic_bowl: 2 }, energyRequired: 2, ticksToComplete: 2, tier: 2, age: 2 },
    { id: 'copper_statue', inputs: { copper_ingot: 3, copper_sheet: 2 }, outputs: { copper_statue: 1 }, energyRequired: 6, ticksToComplete: 6, tier: 2, age: 2 },
    { id: 'magnifying_glass', inputs: { glass_lens: 1, brass_sheet: 1 }, outputs: { magnifying_glass: 1 }, energyRequired: 4, ticksToComplete: 4, tier: 2, age: 2 },
    { id: 'sundial', inputs: { stone_slab: 1, brass_sheet: 1 }, outputs: { sundial: 1 }, energyRequired: 3, ticksToComplete: 3, tier: 2, age: 2 },
    { id: 'bronze_armor', inputs: { bronze_ingot: 6, iron_chain: 4 }, outputs: { bronze_armor: 1 }, energyRequired: 12, ticksToComplete: 10, tier: 2, age: 2 },
    ...
    { id: 'conveyor_belt', inputs: { ball_bearing: 8, steel_chain: 4, steel_beam: 2, electric_motor: 1 }, outputs: { conveyor_belt: 1 }, energyRequired: 25, ticksToComplete: 12, tier: 3, age: 3 },
    { id: 'pressure_cooker', inputs: { steel_plate: 2, pressure_gauge: 1, steam_valve: 1 }, outputs: { pressure_cooker: 1 }, energyRequired: 15, ticksToComplete: 8, tier: 3, age: 3 },
    { id: 'plumbing_system', inputs: { steel_pipe: 6, coupling: 4, steam_valve: 2 }, outputs: { plumbing_system: 1 }, energyRequired: 18, ticksToComplete: 10, tier: 3, age: 3 },
    { id: 'rotary_engine', inputs: { steel_ingot: 4, camshaft: 1, crankshaft: 1, ball_bearing: 4, gear: 3 }, outputs: { rotary_engine: 1 }, energyRequired: 50, ticksToComplete: 20, tier: 3, age: 3 },
    ...
    { id: 'gasoline', inputs: { oil: 2 }, outputs: { gasoline: 2 }, energyRequired: 10, ticksToComplete: 3, tier: 4, age: 4 },
    { id: 'diesel_fuel', inputs: { oil: 2 }, outputs: { diesel_fuel: 2 }, energyRequired: 10, ticksToComplete: 3, tier: 4, age: 4 },
    { id: 'lubricant', inputs: { oil: 1 }, outputs: { lubricant: 2 }, energyRequired: 8, ticksToComplete: 2, tier: 4, age: 4 },
    ...
    { id: 'battery', inputs: { plastic: 1, steel_plate: 1, copper_ingot: 1 }, outputs: { battery: 1 }, energyRequired: 15, ticksToComplete: 5, tier: 4, age: 4 },
    { id: 'light_bulb', inputs: { glass: 1, copper_wire: 1 }, outputs: { light_bulb: 4 }, energyRequired: 4, ticksToComplete: 2, tier: 4, age: 4 },

    // Final Goods Age 4
    { id: 'car_tire', inputs: { tire: 1, steel_plate: 1 }, outputs: { car_tire: 1 }, energyRequired: 5, ticksToComplete: 2, tier: 4, age: 4 },
    { id: 'car_engine', inputs: { engine_block: 1, carburetor: 1, spark_plug: 4, lubricant: 1 }, outputs: { car_engine: 1 }, energyRequired: 40, ticksToComplete: 15, tier: 4, age: 4 },
    { id: 'lawn_mower', inputs: { engine_block: 1, steel_plate: 2, tire: 4, gasoline: 1 }, outputs: { lawn_mower: 1 }, energyRequired: 40, ticksToComplete: 12, tier: 4, age: 4 },
    ...
    { id: 'power_saw', inputs: { engine_block: 1, saw: 1, plastic: 1 }, outputs: { power_saw: 1 }, energyRequired: 25, ticksToComplete: 8, tier: 4, age: 4 },
    { id: 'jackhammer', inputs: { engine_block: 1, chisel: 2, steel_spring: 2 }, outputs: { jackhammer: 1 }, energyRequired: 30, ticksToComplete: 8, tier: 4, age: 4 },
    { id: 'concrete_mixer', inputs: { engine_block: 1, steel_plate: 4, wheel: 2 }, outputs: { concrete_mixer: 1 }, energyRequired: 50, ticksToComplete: 15, tier: 4, age: 4 },
    { id: 'traffic_light', inputs: { steel_pipe: 1, light_bulb: 3, glass_lens: 3 }, outputs: { traffic_light: 1 }, energyRequired: 20, ticksToComplete: 6, tier: 4, age: 4 },
    { id: 'street_lamp', inputs: { steel_pipe: 2, light_bulb: 1, glass: 1 }, outputs: { street_lamp: 1 }, energyRequired: 15, ticksToComplete: 5, tier: 4, age: 4 },
    { id: 'telephone', inputs: { plastic: 2, copper_wire: 2, steel_spring: 1 }, outputs: { telephone: 1 }, energyRequired: 15, ticksToComplete: 5, tier: 4, age: 4 },
    { id: 'vinyl_record', inputs: { vinyl: 1 }, outputs: { vinyl_record: 2 }, energyRequired: 5, ticksToComplete: 2, tier: 4, age: 4 },
    { id: 'plastic_container', inputs: { plastic: 1 }, outputs: { plastic_container: 4 }, energyRequired: 4, ticksToComplete: 1, tier: 4, age: 4 },
    { id: 'garden_hose', inputs: { rubber: 1, brass_ingot: 1 }, outputs: { garden_hose: 1 }, energyRequired: 6, ticksToComplete: 2, tier: 4, age: 4 },
    { id: 'fuel_tank', inputs: { steel_plate: 4, steel_pipe: 1 }, outputs: { fuel_tank: 1 }, energyRequired: 20, ticksToComplete: 6, tier: 4, age: 4 },
    { id: 'oil_drum', inputs: { steel_plate: 2 }, outputs: { oil_drum: 1 }, energyRequired: 10, ticksToComplete: 3, tier: 4, age: 4 },
    { id: 'flashlight', inputs: { plastic: 1, light_bulb: 1, battery: 1 }, outputs: { flashlight: 1 }, energyRequired: 8, ticksToComplete: 2, tier: 4, age: 4 },
    { id: 'road_segment', inputs: { asphalt: 4, concrete: 2 }, outputs: { road_segment: 1 }, energyRequired: 20, ticksToComplete: 5, tier: 4, age: 4 },
    ...
    { id: 'capacitor', inputs: { aluminum_sheet: 1, plastic: 1 }, outputs: { capacitor: 4 }, energyRequired: 8, ticksToComplete: 2, tier: 5, age: 5 },
    { id: 'resistor', inputs: { ceramic_tile: 1, copper_wire: 1 }, outputs: { resistor: 8 }, energyRequired: 5, ticksToComplete: 1, tier: 5, age: 5 },
    { id: 'bulb_socket', inputs: { plastic: 1, brass_sheet: 1 }, outputs: { bulb_socket: 2 }, energyRequired: 5, ticksToComplete: 1, tier: 5, age: 5 },
    ...
    { id: 'toaster', inputs: { heating_element: 2, aluminum_sheet: 1, plastic: 1, electric_switch: 1 }, outputs: { toaster: 1 }, energyRequired: 15, ticksToComplete: 4, tier: 5, age: 5 },
    { id: 'vacuum', inputs: { electric_motor: 1, plastic: 3, pipe: 1 }, outputs: { vacuum: 1 }, energyRequired: 30, ticksToComplete: 6, tier: 5, age: 5 },
    { id: 'fridge', inputs: { aluminum_sheet: 4, compressor: 1, plastic: 2, thermostat: 1 }, outputs: { fridge: 1 }, energyRequired: 50, ticksToComplete: 10, tier: 5, age: 5 },
    { id: 'washer', inputs: { steel_plate: 3, electric_motor: 1, glass: 1, rubber: 1 }, outputs: { washer: 1 }, energyRequired: 50, ticksToComplete: 10, tier: 5, age: 5 },
    { id: 'dishwasher', inputs: { steel_plate: 3, electric_motor: 1, plastic: 2, heating_element: 1 }, outputs: { dishwasher: 1 }, energyRequired: 50, ticksToComplete: 10, tier: 5, age: 5 },
    { id: 'air_conditioner', inputs: { compressor: 1, fan: 1, aluminum_sheet: 2 }, outputs: { air_conditioner: 1 }, energyRequired: 60, ticksToComplete: 12, tier: 5, age: 5 },
    { id: 'electric_oven', inputs: { heating_element: 4, steel_plate: 4, glass: 1, thermostat: 1 }, outputs: { electric_oven: 1 }, energyRequired: 55, ticksToComplete: 10, tier: 5, age: 5 },
    { id: 'radio', inputs: { plastic: 2, insulated_wire: 3, resistor: 2, capacitor: 2 }, outputs: { radio: 1 }, energyRequired: 25, ticksToComplete: 5, tier: 5, age: 5 },
    ...
    { id: 'blender', inputs: { electric_motor: 1, glass_bottle: 1, plastic: 1 }, outputs: { blender: 1 }, energyRequired: 20, ticksToComplete: 4, tier: 5, age: 5 },
    { id: 'food_processor', inputs: { electric_motor: 1, plastic: 2, steel_plate: 1 }, outputs: { food_processor: 1 }, energyRequired: 25, ticksToComplete: 5, tier: 5, age: 5 },
    { id: 'hair_dryer', inputs: { heating_element: 1, fan: 1, plastic: 1 }, outputs: { hair_dryer: 1 }, energyRequired: 15, ticksToComplete: 3, tier: 5, age: 5 },
    { id: 'electric_heater', inputs: { heating_element: 2, steel_plate: 1, fan: 1 }, outputs: { electric_heater: 1 }, energyRequired: 25, ticksToComplete: 5, tier: 5, age: 5 },
    ...
    { id: 'motor_housing_unit', inputs: { housing: 2, electric_motor: 1, aluminum_sheet: 1 }, outputs: { motor_housing_unit: 1 }, energyRequired: 18, ticksToComplete: 6, tier: 5, age: 5 },
    { id: 'insulated_pipe', inputs: { steel_pipe: 2, insulation: 1 }, outputs: { insulated_pipe: 1 }, energyRequired: 10, ticksToComplete: 4, tier: 5, age: 5 },
    { id: 'relay_panel', inputs: { relay: 6, circuit_board: 1, steel_plate: 1 }, outputs: { relay_panel: 1 }, energyRequired: 22, ticksToComplete: 8, tier: 5, age: 5 },
    { id: 'wire_spool', inputs: { steel_wire: 10, aluminum_rod: 1 }, outputs: { wire_spool: 1 }, energyRequired: 8, ticksToComplete: 3, tier: 5, age: 5 },
    { id: 'lamp_fixture', inputs: { bulb_socket: 3, aluminum_sheet: 1, steel_bracket: 2 }, outputs: { lamp_fixture: 1 }, energyRequired: 10, ticksToComplete: 4, tier: 5, age: 5 },
    ...
    { id: 'circuit_board', inputs: { plastic_sheet: 1, copper_wire: 2 }, outputs: { circuit_board: 2 }, energyRequired: 15, ticksToComplete: 3, tier: 6, age: 6 },
    { id: 'cpu', inputs: { silicon: 2, circuit_board: 1 }, outputs: { cpu: 1 }, energyRequired: 50, ticksToComplete: 8, tier: 6, age: 6 },
    { id: 'led', inputs: { plastic: 1, silicon: 1 }, outputs: { led: 4 }, energyRequired: 10, ticksToComplete: 2, tier: 6, age: 6 },
    { id: 'screen', inputs: { glass: 2, plastic: 1, led: 4 }, outputs: { screen: 1 }, energyRequired: 30, ticksToComplete: 5, tier: 6, age: 6 },
    { id: 'ram_module', inputs: { circuit_board: 1, silicon: 2 }, outputs: { ram_module: 1 }, energyRequired: 25, ticksToComplete: 4, tier: 6, age: 6 },
    { id: 'hard_drive', inputs: { aluminum_sheet: 1, electric_motor: 1, circuit_board: 1 }, outputs: { hard_drive: 1 }, energyRequired: 35, ticksToComplete: 5, tier: 6, age: 6 },
    { id: 'motherboard', inputs: { circuit_board: 2, cpu: 1, capacitor: 2 }, outputs: { motherboard: 1 }, energyRequired: 45, ticksToComplete: 6, tier: 6, age: 6 },
    { id: 'graphics_card', inputs: { circuit_board: 1, cpu: 1, fan: 1 }, outputs: { graphics_card: 1 }, energyRequired: 50, ticksToComplete: 7, tier: 6, age: 6 },
    ...
    { id: 'computer', inputs: { motherboard: 1, power_supply: 1, hard_drive: 1, ram_module: 1, aluminum_sheet: 2 }, outputs: { computer: 1 }, energyRequired: 100, ticksToComplete: 15, tier: 6, age: 6 },
    { id: 'laptop', inputs: { motherboard: 1, screen: 1, keyboard: 1, battery: 1, plastic: 2 }, outputs: { laptop: 1 }, energyRequired: 120, ticksToComplete: 18, tier: 6, age: 6 },
    { id: 'tv', inputs: { screen: 1, circuit_board: 1, plastic: 4, electric_switch: 1 }, outputs: { tv: 1 }, energyRequired: 80, ticksToComplete: 12, tier: 6, age: 6 },
    { id: 'microwave', inputs: { heating_element: 1, circuit_board: 1, steel_plate: 2, glass: 1 }, outputs: { microwave: 1 }, energyRequired: 60, ticksToComplete: 8, tier: 6, age: 6 },
    ...
    { id: 'console', inputs: { motherboard: 1, graphics_card: 1, plastic: 3 }, outputs: { console: 1 }, energyRequired: 90, ticksToComplete: 12, tier: 6, age: 6 },
    { id: 'printer', inputs: { electric_motor: 2, circuit_board: 1, plastic: 3 }, outputs: { printer: 1 }, energyRequired: 60, ticksToComplete: 8, tier: 6, age: 6 },
    { id: 'watch_digital', inputs: { circuit_board: 1, plastic: 1, battery: 1 }, outputs: { watch_digital: 1 }, energyRequired: 15, ticksToComplete: 3, tier: 6, age: 6 },
    { id: 'server', inputs: { motherboard: 2, hard_drive: 4, power_supply: 2, steel_plate: 4 }, outputs: { server: 1 }, energyRequired: 150, ticksToComplete: 20, tier: 6, age: 6 },
    { id: 'scanner', inputs: { light_bulb: 2, digital_sensor: 1, electric_motor: 1, plastic: 2 }, outputs: { scanner: 1 }, energyRequired: 50, ticksToComplete: 8, tier: 6, age: 6 },
    { id: 'modem', inputs: { circuit_board: 2, plastic: 1 }, outputs: { modem: 1 }, energyRequired: 30, ticksToComplete: 5, tier: 6, age: 6 },
    { id: 'router', inputs: { circuit_board: 2, plastic: 1, radio_transmitter: 1 }, outputs: { router: 1 }, energyRequired: 35, ticksToComplete: 5, tier: 6, age: 6 },
    { id: 'digital_camera', inputs: { digital_sensor: 1, screen: 1, glass_lens: 1, battery: 1 }, outputs: { digital_camera: 1 }, energyRequired: 60, ticksToComplete: 8, tier: 6, age: 6 },
    ...
    { id: 'bracket_assembly', inputs: { steel_bracket: 6, steel_plate: 1 }, outputs: { bracket_assembly: 1 }, energyRequired: 15, ticksToComplete: 5, tier: 6, age: 6 },
    { id: 'computer_station', inputs: { computer: 1, monitor: 2, mouse: 1, keyboard: 1 }, outputs: { computer_station: 1 }, energyRequired: 120, ticksToComplete: 20, tier: 6, age: 6 },
    { id: 'cable_organizer', inputs: { usb_cable: 4, plastic: 2 }, outputs: { cable_organizer: 1 }, energyRequired: 12, ticksToComplete: 4, tier: 6, age: 6 },

    // --- AGE 7: FUTURE ---
    // - Updated with new logic for Age 7
    // Intermediates
    { id: 'adv_battery', inputs: { bauxite: 1, rare_earth_ore: 1, plastic: 1 }, outputs: { adv_battery: 1 }, energyRequired: 60, ticksToComplete: 6, tier: 7, age: 7 },
    ...
    { id: 'drone', inputs: { electric_motor: 4, adv_battery: 1, circuit_board: 1, composite: 1 }, outputs: { drone: 1 }, energyRequired: 90, ticksToComplete: 10, tier: 7, age: 7 },
    ...
    { id: 'vr_headset', inputs: { screen: 2, cpu: 1, plastic: 2, digital_sensor: 2 }, outputs: { vr_headset: 1 }, energyRequired: 100, ticksToComplete: 12, tier: 7, age: 7 },
    ...
    { id: 'flying_car', inputs: { anti_grav_unit: 2, composite: 6, fusion_core: 1 }, outputs: { flying_car: 1 }, energyRequired: 1000, ticksToComplete: 100, tier: 7, age: 7 },
    { id: 'hoverboard', inputs: { anti_grav_unit: 1, composite: 2 }, outputs: { hoverboard: 1 }, energyRequired: 400, ticksToComplete: 30, tier: 7, age: 7 },
    { id: 'printer_3d', inputs: { electric_motor: 3, aluminum_rod: 4, computer: 1 }, outputs: { printer_3d: 1 }, energyRequired: 200, ticksToComplete: 20, tier: 7, age: 7 },
    { id: 'holographic_display', inputs: { holographic_projector: 4, nano_material: 2 }, outputs: { holographic_display: 1 }, energyRequired: 300, ticksToComplete: 25, tier: 7, age: 7 },
    { id: 'ar_glasses', inputs: { holographic_projector: 1, cpu: 1, glass_lens: 2 }, outputs: { ar_glasses: 1 }, energyRequired: 180, ticksToComplete: 15, tier: 7, age: 7 },
    { id: 'exoskeleton', inputs: { electric_motor: 8, composite: 4, ai_core: 1, adv_battery: 2 }, outputs: { exoskeleton: 1 }, energyRequired: 600, ticksToComplete: 40, tier: 7, age: 7 },
    ...
    { id: 'energy_shield', inputs: { plasma_containment: 2, fusion_core: 1 }, outputs: { energy_shield: 1 }, energyRequired: 1000, ticksToComplete: 80, tier: 7, age: 7 },
    { id: 'weather_control', inputs: { quantum_computer: 1, digital_sensor: 20, anti_grav_unit: 4 }, outputs: { weather_control: 1 }, energyRequired: 3000, ticksToComplete: 150, tier: 7, age: 7 },
    { id: 'replicator', inputs: { quantum_computer: 1, teleporter_pad: 1, nano_material: 20 }, outputs: { replicator: 1 }, energyRequired: 8000, ticksToComplete: 300, tier: 7, age: 7 },
    { id: 'cryogenic_chamber', inputs: { liquid_nitrogen: 6, composite: 4, digital_sensor: 2 }, outputs: { cryogenic_chamber: 1 }, energyRequired: 600, ticksToComplete: 60, tier: 7, age: 7 },
    { id: 'space_helmet', inputs: { helmet: 1, composite: 2, glass: 1 }, outputs: { space_helmet: 1 }, energyRequired: 120, ticksToComplete: 15, tier: 7, age: 7 },
    { id: 'graphene_armor', inputs: { graphene_sheet: 8, composite: 4, nano_material: 2 }, outputs: { graphene_armor: 1 }, energyRequired: 400, ticksToComplete: 40, tier: 7, age: 7 },
