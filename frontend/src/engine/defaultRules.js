...
export const defaultRules = {
  ...
  materials: [
        ...
        { id: 'coal', name: 'Coal', basePrice: 2, category: 'raw', weight: 1, age: 1 },
      ...
      recipes: [
        ...
        { id: 'iron_ingot', inputs: { iron_ore: 2, coal: 1 }, outputs: { iron_ingot: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 1, age: 1 },
        ...
        // --- AGE 2: REFINEMENT ---
        // Intermediates
        { id: 'bricks', inputs: { clay: 2, coal: 1 }, outputs: { bricks: 3 }, energyRequired: 2, ticksToComplete: 2, tier: 2, age: 2 },
        { id: 'glass', inputs: { sand: 2, coal: 1 }, outputs: { glass: 2 }, energyRequired: 3, ticksToComplete: 2, tier: 2, age: 2 },
        { id: 'copper_ingot', inputs: { copper_ore: 2, coal: 1 }, outputs: { copper_ingot: 1 }, energyRequired: 2, ticksToComplete: 2, tier: 2, age: 2 },
        ...
        // --- AGE 5: ELECTRIC ---
        // Intermediates
        { id: 'aluminum_ingot', inputs: { bauxite: 2, coal: 2 }, outputs: { aluminum_ingot: 1 }, energyRequired: 25, ticksToComplete: 4, tier: 5, age: 5 },
        ...
        // --- AGE 6: DIGITAL ---
        // Intermediates
        { id: 'silicon', inputs: { sand: 4, coal: 2 }, outputs: { silicon: 1 }, energyRequired: 40, ticksToComplete: 5, tier: 6, age: 6 },
