...
export const defaultRules = {
  ...
  recipes: [
    ...
    { id: 'silicon_bulk', inputs: { sand: 10 }, outputs: { silicon: 10 }, ticksToComplete: 5, age: 6 },
    ...
    { id: 'plastic_sheet', inputs: { plastic: 2 }, outputs: { plastic_sheet: 4 }, ticksToComplete: 2, age: 4 },
    ...
    { id: 'circuit_board', inputs: { plastic_sheet: 1, copper_wire: 2 }, outputs: { circuit_board: 4 }, ticksToComplete: 3, age: 6 },
    ...
    { id: 'digital_sensor', inputs: { silicon: 1, circuit_board: 1 }, outputs: { digital_sensor: 5 }, ticksToComplete: 3, age: 6 },
    ...
    { id: 'nano_material', inputs: { composite: 1, silicon: 1 }, outputs: { nano_material: 5 }, ticksToComplete: 10, age: 7 },
    { id: 'superconductor', inputs: { rare_earth_ore: 1, copper_wire: 4 }, outputs: { superconductor: 6 }, ticksToComplete: 10, age: 7 },
    { id: 'quantum_processor', inputs: { superconductor: 2, silicon: 2, laser: 1 }, outputs: { quantum_processor: 2 }, ticksToComplete: 20, age: 7 },
    { id: 'ai_core', inputs: { quantum_processor: 1, motherboard: 2, rare_earth_ore: 1 }, outputs: { ai_core: 1 }, ticksToComplete: 30, age: 7 },
    { id: 'plasma_containment', inputs: { superconductor: 4, aluminum_sheet: 2 }, outputs: { plasma_containment: 2 }, ticksToComplete: 15, age: 7 },
    { id: 'fusion_core', inputs: { plasma_containment: 1, rare_earth_ore: 1 }, outputs: { fusion_core: 2 }, ticksToComplete: 40, age: 7 },
    ...
    { id: 'laser', inputs: { rare_earth_ore: 1, glass: 2, circuit_board: 2 , cpu:1}, outputs: { laser: 1 }, ticksToComplete: 15, age: 7 },
  ...
  machines: [
    ...
    },
    {
      ...
      allowedRecipes: [
        ...
        'iron_ingot_bulk', 'copper_ingot_bulk', 'steel_ingot_bulk', 'aluminum_ingot_bulk', 'silicon_bulk' // Consolidating all ingot/hot processing
      ]
    },
    {
      id: 'chemical_plant',
