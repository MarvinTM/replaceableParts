...
export const defaultRules = {
  ...
  recipes: [
    ...
    { id: 'pot', inputs: { copper_sheet: 1 }, outputs: { pot: 1 }, ticksToComplete: 2, age: 2 },
    ...
    { id: 'decorative_urn', inputs: { terracotta: 2 }, outputs: { decorative_urn: 1 }, ticksToComplete: 4, age: 2 },
    ...
    { id: 'ceramic_bowl', inputs: { clay: 2 }, outputs: { ceramic_bowl: 2 }, ticksToComplete: 2, age: 2 },
