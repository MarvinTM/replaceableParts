...
export const defaultRules = {
  ...
  machineRecipes: {
    stone_furnace: {
      slots: [
        { label: 'Base Stone', material: 'stone' },
        { label: 'Left Wall', material: 'stone' },
        { label: 'Right Wall', material: 'stone' },
        { label: 'Back Wall', material: 'stone' },
        { label: 'Front Left', material: 'stone' },
        { label: 'Front Right', material: 'stone' },
        { label: 'Chimney Base', material: 'stone' },
        { label: 'Chimney Top', material: 'stone' }
      ]
    },
    carpenters_bench: {
      slots: [
        { label: 'Work Surface', material: 'planks' },
        { label: 'Surface Board', material: 'planks' },
        { label: 'Front Panel', material: 'planks' },
        { label: 'Back Panel', material: 'planks' },
        { label: 'Left Panel', material: 'planks' },
        { label: 'Right Panel', material: 'planks' },
        { label: 'Left Support', material: 'wooden_beam' },
        { label: 'Right Support', material: 'wooden_beam' },
        { label: 'Surface Nail 1', material: 'nails' },
        { label: 'Surface Nail 2', material: 'nails' },
        { label: 'Surface Nail 3', material: 'nails' },
        { label: 'Surface Nail 4', material: 'nails' },
        { label: 'Frame Nail 1', material: 'nails' },
        { label: 'Frame Nail 2', material: 'nails' },
        { label: 'Frame Nail 3', material: 'nails' },
        { label: 'Frame Nail 4', material: 'nails' },
        { label: 'Joint Nail 1', material: 'nails' },
        { label: 'Joint Nail 2', material: 'nails' }
      ]
    },
    blacksmiths_anvil: {
      slots: [
        { label: 'Anvil Face', material: 'iron_plate' },
        { label: 'Anvil Body', material: 'iron_plate' },
        { label: 'Base Plate', material: 'iron_plate' },
        { label: 'Mounting Plate', material: 'iron_plate' },
        { label: 'Left Leg', material: 'iron_rod' },
        { label: 'Right Leg', material: 'iron_rod' },
        { label: 'Front Support', material: 'iron_rod' },
        { label: 'Rear Support', material: 'iron_rod' }
      ]
    },
    masons_workshop: {
      slots: [
        { label: 'Work Stone 1', material: 'stone' },
        { label: 'Work Stone 2', material: 'stone' },
        { label: 'Base Stone 1', material: 'stone' },
        { label: 'Base Stone 2', material: 'stone' },
        { label: 'Left Stone', material: 'stone' },
        { label: 'Right Stone', material: 'stone' },
        { label: 'Back Stone 1', material: 'stone' },
        { label: 'Back Stone 2', material: 'stone' },
        { label: 'Left Beam', material: 'wooden_beam' },
        { label: 'Right Beam', material: 'wooden_beam' }
      ]
    },
    glassblowers_workshop: {
      slots: [
        { label: 'Furnace Plate 1', material: 'iron_plate' },
        { label: 'Furnace Plate 2', material: 'iron_plate' },
        { label: 'Frame Plate 1', material: 'iron_plate' },
        { label: 'Frame Plate 2', material: 'iron_plate' },
        { label: 'Kiln Brick 1', material: 'bricks' },
        { label: 'Kiln Brick 2', material: 'bricks' },
        { label: 'Kiln Brick 3', material: 'bricks' },
        { label: 'Kiln Brick 4', material: 'bricks' },
        { label: 'Chamber Brick 1', material: 'bricks' },
        { label: 'Chamber Brick 2', material: 'bricks' },
        { label: 'Chamber Brick 3', material: 'bricks' },
        { label: 'Chamber Brick 4', material: 'bricks' },
        { label: 'Air Tube', material: 'copper_tubing' },
        { label: 'Bellows Tube', material: 'copper_tubing' }
      ]
    },
    potters_wheel_machine: {
      slots: [
        { label: 'Frame Beam 1', material: 'wooden_beam' },
        { label: 'Frame Beam 2', material: 'wooden_beam' },
        { label: 'Support Beam 1', material: 'wooden_beam' },
        { label: 'Support Beam 2', material: 'wooden_beam' },
        { label: 'Axle Rod', material: 'iron_rod' },
        { label: 'Bearing Rod', material: 'iron_rod' },
        { label: 'Base Stone 1', material: 'stone' },
        { label: 'Base Stone 2', material: 'stone' },
        { label: 'Wheel Stone 1', material: 'stone' },
        { label: 'Wheel Stone 2', material: 'stone' }
      ]
    },
    foundry: {
      slots: [
        { label: 'Furnace Brick 1', material: 'bricks' },
        { label: 'Furnace Brick 2', material: 'bricks' },
        { label: 'Furnace Brick 3', material: 'bricks' },
        { label: 'Furnace Brick 4', material: 'bricks' },
        { label: 'Chamber Brick 1', material: 'bricks' },
        { label: 'Chamber Brick 2', material: 'bricks' },
        { label: 'Chamber Brick 3', material: 'bricks' },
        { label: 'Chamber Brick 4', material: 'bricks' },
        { label: 'Stack Brick 1', material: 'bricks' },
        { label: 'Stack Brick 2', material: 'bricks' },
        { label: 'Frame Beam 1', material: 'steel_beam' },
        { label: 'Frame Beam 2', material: 'steel_beam' },
        { label: 'Support Beam 1', material: 'steel_beam' },
        { label: 'Support Beam 2', material: 'steel_beam' }
      ]
    },
    steel_forge: {
      slots: [
        { label: 'Frame Plate 1', material: 'steel_plate' },
        { label: 'Frame Plate 2', material: 'steel_plate' },
        { label: 'Frame Plate 3', material: 'steel_plate' },
        { label: 'Frame Plate 4', material: 'steel_plate' },
        { label: 'Chamber Plate 1', material: 'steel_plate' },
        { label: 'Chamber Plate 2', material: 'steel_plate' },
        { label: 'Door Plate 1', material: 'steel_plate' },
        { label: 'Door Plate 2', material: 'steel_plate' },
        { label: 'Base Plate 1', material: 'steel_plate' },
        { label: 'Base Plate 2', material: 'steel_plate' },
        { label: 'Inner Brick 1', material: 'bricks' },
        { label: 'Inner Brick 2', material: 'bricks' },
        { label: 'Inner Brick 3', material: 'bricks' },
        { label: 'Inner Brick 4', material: 'bricks' },
        { label: 'Lining Brick 1', material: 'bricks' },
        { label: 'Lining Brick 2', material: 'bricks' },
        { label: 'Lining Brick 3', material: 'bricks' },
        { label: 'Lining Brick 4', material: 'bricks' },
        { label: 'Floor Brick 1', material: 'bricks' },
        { label: 'Floor Brick 2', material: 'bricks' },
        { label: 'Floor Brick 3', material: 'bricks' },
        { label: 'Floor Brick 4', material: 'bricks' },
        { label: 'Hoist Chain 1', material: 'iron_chain' },
        { label: 'Hoist Chain 2', material: 'iron_chain' },
        { label: 'Door Chain 1', material: 'iron_chain' },
        { label: 'Door Chain 2', material: 'iron_chain' }
      ]
    },
    heavy_assembly: {
      slots: [
        { label: 'Frame Beam 1', material: 'steel_beam' },
        { label: 'Frame Beam 2', material: 'steel_beam' },
        { label: 'Frame Beam 3', material: 'steel_beam' },
        { label: 'Frame Beam 4', material: 'steel_beam' },
        { label: 'Support Beam 1', material: 'steel_beam' },
        { label: 'Support Beam 2', material: 'steel_beam' },
        { label: 'Cross Beam 1', material: 'steel_beam' },
        { label: 'Cross Beam 2', material: 'steel_beam' },
        { label: 'Platform Plate 1', material: 'steel_plate' },
        { label: 'Platform Plate 2', material: 'steel_plate' },
        { label: 'Platform Plate 3', material: 'steel_plate' },
        { label: 'Platform Plate 4', material: 'steel_plate' },
        { label: 'Base Plate 1', material: 'steel_plate' },
        { label: 'Base Plate 2', material: 'steel_plate' },
        { label: 'Side Plate 1', material: 'steel_plate' },
        { label: 'Side Plate 2', material: 'steel_plate' },
        { label: 'Drive Gear 1', material: 'gear' },
        { label: 'Drive Gear 2', material: 'gear' },
        { label: 'Transfer Gear 1', material: 'gear' },
        { label: 'Transfer Gear 2', material: 'gear' },
        { label: 'Lift Gear 1', material: 'gear' },
        { label: 'Lift Gear 2', material: 'gear' },
        { label: 'Assembly Crane', material: 'crane' }
      ]
    },
    precision_assembler: {
      slots: [
        ...
        { label: 'Base Plate 1', material: 'steel_plate' },
        { label: 'Base Plate 2', material: 'steel_plate' },
        { label: 'Top Plate 1', material: 'steel_plate' },
        { label: 'Top Plate 2', material: 'steel_plate' },
        { label: 'Side Plate 1', material: 'steel_plate' },
        { label: 'Side Plate 2', material: 'steel_plate' },
        { label: 'Drive Gear 1', material: 'gear' },
        { label: 'Drive Gear 2', material: 'gear' },
        { label: 'Feed Gear 1', material: 'gear' },
        { label: 'Feed Gear 2', material: 'gear' },
        { label: 'Precision Gear 1', material: 'gear' },
        { label: 'Precision Gear 2', material: 'gear' },
        { label: 'Index Gear 1', material: 'gear' },
        { label: 'Index Gear 2', material: 'gear' },
        { label: 'Timing Gear 1', material: 'gear' },
        { label: 'Timing Gear 2', material: 'gear' },
        { label: 'Main Motor', material: 'electric_motor' },
        { label: 'Feed Motor', material: 'electric_motor' },
        { label: 'Spindle Bearing 1', material: 'ball_bearing' },
        { label: 'Spindle Bearing 2', material: 'ball_bearing' },
        { label: 'Feed Bearing 1', material: 'ball_bearing' },
        { label: 'Feed Bearing 2', material: 'ball_bearing' }
      ]
    },
    chemical_plant: {
      slots: [
        ...
        { label: 'Frame Plate 3', material: 'steel_plate' },
        { label: 'Frame Plate 4', material: 'steel_plate' },
        { label: 'Vessel Plate 1', material: 'steel_plate' },
        { label: 'Vessel Plate 2', material: 'steel_plate' },
        { label: 'Base Plate 1', material: 'steel_plate' },
        { label: 'Base Plate 2', material: 'steel_plate' },
        { label: 'Top Plate 1', material: 'steel_plate' },
        { label: 'Top Plate 2', material: 'steel_plate' },
        { label: 'Input Pipe 1', material: 'pipe' },
        { label: 'Input Pipe 2', material: 'pipe' },
        { label: 'Output Pipe 1', material: 'pipe' },
        { label: 'Output Pipe 2', material: 'pipe' },
        { label: 'Transfer Pipe 1', material: 'pipe' },
        { label: 'Transfer Pipe 2', material: 'pipe' },
        { label: 'Cooling Pipe 1', material: 'pipe' },
        { label: 'Cooling Pipe 2', material: 'pipe' },
        { label: 'Drain Pipe 1', material: 'pipe' },
        { label: 'Drain Pipe 2', material: 'pipe' },
        { label: 'Sight Glass 1', material: 'glass' },
        { label: 'Sight Glass 2', material: 'glass' },
        { label: 'Gauge Glass 1', material: 'glass' },
        { label: 'Gauge Glass 2', material: 'glass' },
        { label: 'Window Glass', material: 'glass' }
      ]
    },
    electronics_fab: {
      slots: [
        { label: 'Frame Composite 1', material: 'composite' },
        { label: 'Frame Composite 2', material: 'composite' },
        { label: 'Frame Composite 3', material: 'composite' },
        { label: 'Frame Composite 4', material: 'composite' },
        { label: 'Chamber Wall 1', material: 'composite' },
        { label: 'Chamber Wall 2', material: 'composite' },
        { label: 'Chamber Wall 3', material: 'composite' },
        { label: 'Chamber Wall 4', material: 'composite' },
        { label: 'Base Panel 1', material: 'composite' },
        { label: 'Base Panel 2', material: 'composite' },
        { label: 'Main Motor', material: 'electric_motor' },
        { label: 'Feed Motor', material: 'electric_motor' },
        { label: 'Conveyor Motor', material: 'electric_motor' },
        { label: 'Cooling Motor', material: 'electric_motor' },
        { label: 'Pump Motor', material: 'electric_motor' },
        { label: 'Oven Element 1', material: 'heating_element' },
        { label: 'Oven Element 2', material: 'heating_element' },
        { label: 'Oven Element 3', material: 'heating_element' },
        { label: 'Oven Element 4', material: 'heating_element' },
        { label: 'Reflow Element 1', material: 'heating_element' },
        { label: 'Reflow Element 2', material: 'heating_element' },
        { label: 'Reflow Element 3', material: 'heating_element' },
        { label: 'Reflow Element 4', material: 'heating_element' },
        { label: 'Cure Element 1', material: 'heating_element' },
        { label: 'Cure Element 2', material: 'heating_element' },
        { label: 'Control Resistor 1', material: 'resistor' },
        { label: 'Control Resistor 2', material: 'resistor' },
        { label: 'Control Resistor 3', material: 'resistor' },
        { label: 'Control Resistor 4', material: 'resistor' },
        { label: 'Bias Resistor 1', material: 'resistor' },
        { label: 'Bias Resistor 2', material: 'resistor' },
        { label: 'Bias Resistor 3', material: 'resistor' },
        { label: 'Bias Resistor 4', material: 'resistor' },
        { label: 'Limit Resistor 1', material: 'resistor' },
        { label: 'Limit Resistor 2', material: 'resistor' }
      ]
    }
  },
  ...
  generatorRecipes: {
    ...
    steam_engine_gen: {
      slots: [
        ...
        { label: 'Base Plate 1', material: 'steel_plate' },
        { label: 'Base Plate 2', material: 'steel_plate' },
        { label: 'Cover Plate 1', material: 'steel_plate' },
        { label: 'Cover Plate 2', material: 'steel_plate' },
        { label: 'Housing Plate 1', material: 'steel_plate' },
        { label: 'Housing Plate 2', material: 'steel_plate' },
        { label: 'Pressure Boiler', material: 'boiler' },
        { label: 'Drive Piston', material: 'piston' },
        { label: 'Power Piston', material: 'piston' }
      ]
    },
    diesel_gen: {
      slots: [
        { label: 'Main Engine', material: 'engine_block' },
        { label: 'Backup Engine', material: 'engine_block' },
        { label: 'Power Generator', material: 'generator' }
      ]
    },
    solar_array: {
      slots: [
        { label: 'Panel 1', material: 'solar_panel_item' },
        { label: 'Panel 2', material: 'solar_panel_item' },
        { label: 'Panel 3', material: 'solar_panel_item' },
        { label: 'Panel 4', material: 'solar_panel_item' },
        { label: 'Panel 5', material: 'solar_panel_item' },
        { label: 'Panel 6', material: 'solar_panel_item' },
        { label: 'Panel 7', material: 'solar_panel_item' },
        { label: 'Panel 8', material: 'solar_panel_item' },
        { label: 'Panel 9', material: 'solar_panel_item' },
        { label: 'Panel 10', material: 'solar_panel_item' },
        { label: 'Panel 11', material: 'solar_panel_item' },
        { label: 'Panel 12', material: 'solar_panel_item' },
        { label: 'Panel 13', material: 'solar_panel_item' },
        { label: 'Panel 14', material: 'solar_panel_item' },
        { label: 'Panel 15', material: 'solar_panel_item' },
        { label: 'Panel 16', material: 'solar_panel_item' },
        { label: 'Frame Sheet 1', material: 'aluminum_sheet' },
        { label: 'Frame Sheet 2', material: 'aluminum_sheet' },
        { label: 'Mount Sheet 1', material: 'aluminum_sheet' },
        { label: 'Mount Sheet 2', material: 'aluminum_sheet' }
      ]
    },
    fusion_reactor: {
      slots: [
        { label: 'Fusion Core', material: 'fusion_core' },
        { label: 'Coil 1', material: 'superconductor' },
        { label: 'Coil 2', material: 'superconductor' },
        { label: 'Coil 3', material: 'superconductor' },
        { label: 'Coil 4', material: 'superconductor' },
        { label: 'Coil 5', material: 'superconductor' },
        { label: 'Coil 6', material: 'superconductor' },
        { label: 'Coil 7', material: 'superconductor' },
        { label: 'Coil 8', material: 'superconductor' },
        { label: 'Coil 9', material: 'superconductor' },
        { label: 'Coil 10', material: 'superconductor' },
        { label: 'Magnet 1', material: 'superconductor' },
        { label: 'Magnet 2', material: 'superconductor' },
        { label: 'Magnet 3', material: 'superconductor' },
        { label: 'Magnet 4', material: 'superconductor' },
        { label: 'Magnet 5', material: 'superconductor' },
        { label: 'Magnet 6', material: 'superconductor' },
        { label: 'Magnet 7', material: 'superconductor' },
        { label: 'Magnet 8', material: 'superconductor' },
        { label: 'Magnet 9', material: 'superconductor' },
        { label: 'Magnet 10', material: 'superconductor' },
        { label: 'Foundation 1', material: 'concrete' },
        { label: 'Foundation 2', material: 'concrete' },
        { label: 'Foundation 3', material: 'concrete' },
        { label: 'Foundation 4', material: 'concrete' },
        { label: 'Foundation 5', material: 'concrete' },
        { label: 'Foundation 6', material: 'concrete' },
        { label: 'Foundation 7', material: 'concrete' },
        { label: 'Foundation 8', material: 'concrete' },
        { label: 'Foundation 9', material: 'concrete' },
        { label: 'Foundation 10', material: 'concrete' },
        { label: 'Shielding 1', material: 'concrete' },
        { label: 'Shielding 2', material: 'concrete' },
        { label: 'Shielding 3', material: 'concrete' },
        { label: 'Shielding 4', material: 'concrete' },
        { label: 'Shielding 5', material: 'concrete' },
        { label: 'Shielding 6', material: 'concrete' },
        { label: 'Shielding 7', material: 'concrete' },
        { label: 'Shielding 8', material: 'concrete' },
        { label: 'Shielding 9', material: 'concrete' },
        { label: 'Shielding 10', material: 'concrete' },
        { label: 'Containment 1', material: 'concrete' },
        { label: 'Containment 2', material: 'concrete' },
        { label: 'Containment 3', material: 'concrete' },
        { label: 'Containment 4', material: 'concrete' },
        { label: 'Containment 5', material: 'concrete' },
        { label: 'Containment 6', material: 'concrete' },
        { label: 'Containment 7', material: 'concrete' },
        { label: 'Containment 8', material: 'concrete' },
        { label: 'Containment 9', material: 'concrete' },
        { label: 'Containment 10', material: 'concrete' },
        { label: 'Wall Block 1', material: 'concrete' },
        { label: 'Wall Block 2', material: 'concrete' },
        { label: 'Wall Block 3', material: 'concrete' },
        { label: 'Wall Block 4', material: 'concrete' },
        { label: 'Wall Block 5', material: 'concrete' },
        { label: 'Wall Block 6', material: 'concrete' },
        { label: 'Wall Block 7', material: 'concrete' },
        { label: 'Wall Block 8', material: 'concrete' },
        { label: 'Wall Block 9', material: 'concrete' },
        { label: 'Wall Block 10', material: 'concrete' },
        { label: 'Base Block 1', material: 'concrete' },
        { label: 'Base Block 2', material: 'concrete' },
        { label: 'Base Block 3', material: 'concrete' },
        { label: 'Base Block 4', material: 'concrete' },
        { label: 'Base Block 5', material: 'concrete' },
        { label: 'Base Block 6', material: 'concrete' },
        { label: 'Base Block 7', material: 'concrete' },
        { label: 'Base Block 8', material: 'concrete' },
        { label: 'Base Block 9', material: 'concrete' },
        { label: 'Base Block 10', material: 'concrete' },
        { label: 'Cap Block 1', material: 'concrete' },
        { label: 'Cap Block 2', material: 'concrete' },
        { label: 'Cap Block 3', material: 'concrete' },
        { label: 'Cap Block 4', material: 'concrete' },
        { label: 'Cap Block 5', material: 'concrete' },
        { label: 'Cap Block 6', material: 'concrete' },
        { label: 'Cap Block 7', material: 'concrete' },
        { label: 'Cap Block 8', material: 'concrete' },
        { label: 'Cap Block 9', material: 'concrete' },
        { label: 'Cap Block 10', material: 'concrete' },
        { label: 'Support Block 1', material: 'concrete' },
        { label: 'Support Block 2', material: 'concrete' },
        { label: 'Support Block 3', material: 'concrete' },
        { label: 'Support Block 4', material: 'concrete' },
        { label: 'Support Block 5', material: 'concrete' },
        { label: 'Support Block 6', material: 'concrete' },
        { label: 'Support Block 7', material: 'concrete' },
        { label: 'Support Block 8', material: 'concrete' },
        { label: 'Support Block 9', material: 'concrete' },
        { label: 'Support Block 10', material: 'concrete' },
        { label: 'Ring Block 1', material: 'concrete' },
        { label: 'Ring Block 2', material: 'concrete' },
        { label: 'Ring Block 3', material: 'concrete' },
        { label: 'Ring Block 4', material: 'concrete' },
        { label: 'Ring Block 5', material: 'concrete' },
        { label: 'Ring Block 6', material: 'concrete' },
        { label: 'Ring Block 7', material: 'concrete' },
        { label: 'Ring Block 8', material: 'concrete' },
        { label: 'Ring Block 9', material: 'concrete' },
        { label: 'Ring Block 10', material: 'concrete' }
      ]
    }
  },
